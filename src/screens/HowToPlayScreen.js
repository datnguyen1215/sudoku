    ...
    <SafeAreaView className="flex-1 bg-cream">
      <View className="flex-1">
        ...
        <View className="flex-row justify-between items-center px-5 py-4 border-b border-desertBrown">
          ...
          <Text className="text-xl font-bold text-darkChocolate">How to Play</Text>
          <View className="w-8" />
        </View>
        ...
        <ScrollView className="flex-1 px-5 py-4">
          {/* Objective Section */}
          <View className="mb-4">
            <Text className="text-base font-bold text-mahogany mb-2">Objective</Text>
            <Text className="text-sm text-brown leading-5">
              Fill the 9x9 grid with numbers 1-9 so that each row, column, and 3x3 box contains all digits from 1 to 9.
            </Text>
          </View>

          {/* The Grid Section */}
          <View className="mb-4">
            <Text className="text-base font-bold text-mahogany mb-2">The Grid</Text>
          ...
          {/* Rules Section */}
          <View className="mb-4">
            <Text className="text-base font-bold text-mahogany mb-2">Rules</Text>
            <Text className="text-sm text-brown leading-5">
